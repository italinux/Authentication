...
$t->ok(Propel::getTable('Project')->getProjectRelatedMilestonesAndIssues(1) instanceof Project, 'getProjectRelatedMilestonesAndIssues(1) returns a propject object');
$t->is(Propel::getTable('Project')->getProjectRelatedMilestonesAndIssues(1213782), null, 'getProjectRelatedMilestonesAndIssues(1213782) returns null if the project is not found');

$t->ok(Propel::getTable('Project')->getProjectMilestonesAndUsers(1) instanceof Project, 'getProjectMilestonesAndUsers(1) returns a propject object');
$t->is(Propel::getTable('Project')->getProjectMilestonesAndUsers(1213782), null, 'getProjectMilestonesAndUsers(1213782) returns null if the project is not found');

$projects = Propel::getTable('Project')->getQueryToRetrieveProjectWhereUserHaveAssignedIssues(2)->execute();
...
$t->is(Propel::getTable('Project')->projectExists(1), true, 'projectExists() return true for project 1');
$t->is(Propel::getTable('Project')->projectExists(5), true, 'projectExists() return true for project 5');
$t->is(Propel::getTable('Project')->projectExists(11111111), false, 'projectExists() return true for project 11111111');

$project_is = Propel::getTable('Project')->getRecentPrjectsIdAndName();
...
$projects_reports = Propel::getTable('Project')->getReportsForRecentProjects();
...
$has_exceeded_estimated_hours = Propel::getTable('Project')->hasExceededEstimatedHours(5);
$t->ok(!$has_exceeded_estimated_hours, '->hasExceededEstimatedHours() return false');

$has_exceeded_estimated_hours = Propel::getTable('Project')->hasExceededEstimatedHours(3);
$t->ok(!$has_exceeded_estimated_hours, '->hasExceededEstimatedHours() return false');

$has_exceeded_estimated_hours = Propel::getTable('Project')->hasExceededEstimatedHours(2);
$t->ok(!$has_exceeded_estimated_hours, '->hasExceededEstimatedHours() return false');
...
$data = Propel::getTable('Project')->getEffortDataForChart(1);
...
$projects = Propel::getTable('Project')->createQuery()->where('id = ? OR id = ?', array(1,2))->execute();
$report = Propel::getTable('Project')->getReportsOnProjectsWithEffortChart($projects);
