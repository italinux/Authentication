...
$late_milestones = Propel::getTable('Milestone')->getLateMilestonesByProjectIds(array(1,3));
...
$upcoming_milestones = Propel::getTable('Milestone')->getUpcomingMilestonesByProjectIds(array(1,2));
