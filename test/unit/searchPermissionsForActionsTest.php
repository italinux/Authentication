...
Propel::loadData(sfConfig::get('sf_test_dir').'/fixtures/fixtures_permission_unittest.yml');
...
$permissions = Propel::getTable('sfGuardPermission')->findAll(Propel::HYDRATE_ARRAY);
...
$sggroup_admin = Propel::getTable('sfGuardGroup')
                            ->createQuery()
