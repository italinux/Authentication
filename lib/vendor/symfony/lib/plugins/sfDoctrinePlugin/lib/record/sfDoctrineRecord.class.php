...
/**
 * Base sfPropelRecord extends the base Propel_Record in Propel to provide some
 * symfony specific functionality to Propel_Records
 *
 * @package    symfony
 * @subpackage propel
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @author     Jonathan H. Wage <jonwage@gmail.com>
 * @version    SVN: $Id: sfPropelRecord.class.php 29659 2010-05-28 16:49:48Z Kris.Wallsmith $
 */
abstract class sfPropelRecord extends Propel_Record
{
  static protected
    $_defaultCulture = 'en';
  ...
  public function construct()
  {
    if ($this->getTable()->hasRelation('Translation'))
    {
      ...
      {
        $this->getTable()
          ->unshiftFilter(new sfPropelRecordI18nFilter())
   ...
   *
   * This a proxy method to {@link Propel_Record::identifier()} for
  ...
  public function __call($method, $arguments)
  {
    ...
    if ($failed)
    {
      ...
      } catch (Propel_Record_UnknownPropertyException $e2) {}
  ...
  /**
   * Get the Propel date value as a PHP DateTime object
   *
  ...
  /**
   * Set the Propel date value by passing a valid PHP DateTime object instance
   *
