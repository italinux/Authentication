...
/**
 * Represents a Propel column
 *
 * @package    symfony
 * @subpackage propel
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @author     Jonathan H. Wage <jonwage@gmail.com>
 * @version    SVN: $Id: sfPropelColumn.class.php 24604 2010-11-30 21:00:46Z Jonathan.Wage $
 */
class sfPropelColumn implements ArrayAccess
{
  /**
   * Array mapping Propel column types to the native symfony type
   */
  static $propelToSymfony = array(
    'boolean'   => 'BOOLEAN',
    'string'    => 'LONGVARCHAR',
    'integer'   => 'INTEGER',
    'date'      => 'DATE',
  ...
  /**
   * Propel_Table instance this column belongs to
   *
   * @var Propel_Table $table
   */
  ...
  public function __construct($name, Propel_Table $table)
  {
    $this->name = $name;
    $this->table = $table;
  ...
  /**
   * Get the Propel type of the column
   *
   * @return void
   */
  ...
  public function getType()
  {
    ...
    if ('string' == $propelType && null !== $this->getSize() && $this->getSize() <= 255)
    {
      return 'VARCHAR';
    }

    return $propelType ? self::$propelToSymfony[$propelType] : 'VARCHAR';
  }
  ...
  /**
   * If foreign key get the related Propel_Table object
   *
   * @return Propel_Table $table
   */
  public function getForeignTable()
  {
    if ($this->isForeignKey())
    {
      return Propel_Core::getTable($this->foreignClassName);
    } else {
      return false;
    }
  }
  ...
  /**
   * Set the Propel_Table object this column belongs to
   *
  ...
  /**
   * Get the Propel_Table object this column belongs to
   *
   * @return Propel_Table $table
   */
