 ...
 * @version    SVN: $Id: sfPropelGenerator.class.php 23810 2010-11-12 11:07:44Z Kris.Wallsmith $
 */
class sfPropelGenerator extends sfModelGenerator
{
  ...
  {
    $this->table = Propel_Core::getTable($this->modelClass);
  ...
  public function getManyToManyTables()
  {
    ...
    {
      if ($relation->getType() === Propel_Relation::MANY && isset($relation['refTable']))
      {
        $relations[] = $relation;
      }
    }
  ...
  /**
   * Get array of sfPropelAdminColumn objects
   *
  ...
  public function getColumns()
  {
    foreach (array_keys($this->table->getColumns()) as $name)
    {
      ...
      $columns[$name] = new sfPropelColumn($name, $this->table);
    }
