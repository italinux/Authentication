...
/**
 * sfPropel pager class.
 *
 * @package    sfPropelPlugin
 * @subpackage pager
 * @author     Jonathan H. Wage <jonwage@gmail.com>
 * @version    SVN: $Id: sfPropelPager.class.php 28897 2010-03-30 20:30:24Z Jonathan.Wage $
 */
class sfPropelPager extends sfPager implements Serializable
{
  protected
    $query             = null,
  ...
  public function getQuery()
  {
    if (!$this->tableMethodCalled && $this->tableMethodName)
    {
      ...
      $this->query = Propel_Core::getTable($this->getClass())->$method($this->query);
      $this->tableMethodCalled = true;
    }
    else if (!$this->query)
    {
      $this->query = Propel_Core::getTable($this->getClass())->createQuery();
    }
  ...
  protected function initializeIterator()
  {
    ...
    if ($this->results instanceof Propel_Collection)
    {
