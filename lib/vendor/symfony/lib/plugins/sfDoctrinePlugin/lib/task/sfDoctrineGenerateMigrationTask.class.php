 ...
 * @version    SVN: $Id: sfPropelGenerateMigrationTask.class.php 24390 2010-11-25 18:21:06Z Kris.Wallsmith $
 */
...
The [propel:generate-migration|INFO] task generates migration template

  [./symfony propel:generate-migration AddUserEmailColumn|INFO]

You can provide an [--editor-cmd|COMMENT] option to open the new migration class in your
editor of choice upon creation:

  [./symfony propel:generate-migration AddUserEmailColumn --editor-cmd=mate|INFO]
EOF;
  }
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $this->logSection('propel', sprintf('generating migration class named "%s"', $arguments['name']));
    ...
    $this->callPropelCli('generate-migration', array('name' => $arguments['name']));
