 ...
 * @version    SVN: $Id: sfPropelBuildFiltersTask.class.php 23927 2010-11-14 16:10:57Z fabien $
 */
...
The [propel:build-filters|INFO] task creates form filter classes from the schema:

  [./symfony propel:build-filters|INFO]

This task creates form filter classes based on the model. The classes are
created in [lib/propel/filter|COMMENT].

This task never overrides custom classes in [lib/propel/filter|COMMENT].
It only replaces base classes generated in [lib/propel/filter/base|COMMENT].
EOF;
  }
