 ...
 * @version    SVN: $Id: sfPropelCleanModelFilesTask.class.php 29677 2010-05-30 14:19:33Z Kris.Wallsmith $
 */
class sfPropelCleanModelFilesTask extends sfPropelBaseTask
{
  protected function configure()
  {
    ...
    $this->aliases = array('propel:clean');
...
The [propel:clean-model-files|INFO] task deletes model classes that are not
represented in project or plugin schema.yml files:

  [./symfony propel:clean-model-files|INFO]
EOF;
  }
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $deleteModelFiles = new sfPropelDeleteModelFilesTask($this->dispatcher, $this->formatter);
    ...
    {
      $this->logSection('propel', 'Could not find any files that need to be removed');
    }
  }
  ...
  {
    Propel_Core::loadModels($modelsPath);
    return Propel_Core::getLoadedModels();
  }
}
