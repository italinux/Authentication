 ...
 * @version    SVN: $Id: Swift_PropelSpool.class.php 23810 2010-11-12 11:07:44Z Kris.Wallsmith $
 */
class Swift_PropelSpool extends Swift_ConfigurableSpool
{
  ...
  public function queueMessage(Swift_Mime_Message $message)
  {
    ...
    if (!$object instanceof Propel_Record)
    {
      throw new InvalidArgumentException('The mailer message object must be a Propel_Record object.');
    }
  ...
  {
    $table = Propel_Core::getTable($this->model);
