...
class sfWidgetFormPropelChoice extends sfWidgetFormChoice
{
  ...
  public function getChoices()
  {
    ...
    {
      $query = null === $this->getOption('query') ? Propel_Core::getTable($this->getOption('model'))->createQuery() : $this->getOption('query');
    ...
    else
    {
      ...
      $results = Propel_Core::getTable($this->getOption('model'))->$tableMethod();

      if ($results instanceof Propel_Query)
      {
        $objects = $results->execute();
      }
      else if ($results instanceof Propel_Collection)
      {
        $objects = $results;
      }
      else if ($results instanceof Propel_Record)
      {
        $objects = new Propel_Collection($this->getOption('model'));
        $objects[] = $results;
      }
      else
      {
