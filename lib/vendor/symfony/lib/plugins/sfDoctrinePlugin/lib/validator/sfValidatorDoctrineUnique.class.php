 ...
 * @version    SVN: $Id: sfValidatorPropelUnique.class.php 23810 2010-11-12 11:07:44Z Kris.Wallsmith $
 */
class sfValidatorPropelUnique extends sfValidatorSchema
{
  ...
  protected function doClean($values)
  {
    ...
    $table = Propel_Core::getTable($this->getOption('model'));
    ...
    $q = Propel_Core::getTable($this->getOption('model'))->createQuery('a');
   ...
   */
  protected function isUpdate(Propel_Record $object, $values)
  {
  ...
  protected function getPrimaryKeys()
  {
    ...
    {
      $primaryKeys = Propel_Core::getTable($this->getOption('model'))->getIdentifier();
