 ...
 * @version    SVN: $Id: sfFormPropel.class.php 29643 2010-05-27 15:52:21Z Jonathan.Wage $
 */
abstract class sfFormPropel extends sfFormObject
{
  ...
  {
    return Propel_Manager::getInstance()->getConnectionForComponent($this->getModelName());
  }
  ...
  /**
   * Embed a Propel_Collection relationship in to a form
   *
   *     [php]
  ...
  public function embedRelation($relationName, $formClass = null, $formArgs = array(), $innerDecorator = null, $decorator = null)
  {
    ...
    if (Propel_Relation::ONE == $relation->getType())
    {
  ...
  {
    return $this->getObject()->getTable()->hasTemplate('Propel_Template_I18n');
  }
  ...
  {
    return $this->getObject()->getTable()->getTemplate('Propel_Template_I18n')->getI18n()->getOption('className');
  }
  ...
  {
    return $this->getObject()->getTable()->getTemplate('Propel_Template_I18n')->getI18n()->getOption('i18nField');
  }
