...
$userCount = Propel_Query::create()
  ->from('User u')
  ->count();

$t->is($userCount, 1);

$profileCount = Propel_Query::create()
  ->from('Profile p')
  ->count();

$t->is($profileCount, 1);

$widget = new sfWidgetFormPropelChoice(array('model' => 'User'));
$t->is($widget->getChoices(), array(1 => 1));

$widget = new sfWidgetFormPropelChoice(array('model' => 'User', 'key_method' => 'getUsername', 'method' => 'getPassword'));
...
{
  $widget = new sfWidgetFormPropelChoice(array('model' => 'User', 'table_method' => $method));
  $t->is($widget->getChoices(), array(1 => 1));
}

$widget = new sfWidgetFormPropelChoice(array('model' => 'User', 'table_method' => 'widgetChoiceTableMethod4'));
