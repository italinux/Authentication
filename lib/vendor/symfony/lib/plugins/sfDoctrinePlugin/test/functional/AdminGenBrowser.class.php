...
class AdminGenBrowser extends sfTestBrowser
{
  ...
  {
    parent::__construct();
    $this->setTester('propel', 'sfTesterPropel');
  ...
  {
    $this->info('Run sfPropelPlugin Admin Generator Tests');
  ...
  protected function _testArticleI18nEmbedded()
  {
    ...
    $info = array('author_id' => 1, 'is_on_homepage' => false, 'en' => array('title' => 'Test English title', 'body' => 'Test English body'), 'fr' => array('title' => 'Test French title', 'body' => 'Test French body'), 'created_at' => array('month' => '1', 'day' => '12', 'year' => '2010', 'hour' => '10', 'minute' => '03'), 'updated_at' => array('month' => '1', 'day' => '12', 'year' => '2010', 'hour' => '10', 'minute' => '03'));
  ...
  protected function _testUserEmbedsProfileForm()
  {
    ...
    $user = Propel::getTable('User')->findOneByUsername($userInfo['user']['username']);
  ...
  {    
    ...
    $task = new sfPropelGenerateAdminTask($this->getContext()->getEventDispatcher(), new sfFormatter());
    $task->run(array('application' => 'backend', 'route_or_model' => $model));
  }

  protected function _generateAdminGenModules()
  {
    // $task = new sfPropelBuildAllReloadTask($this->getContext()->getEventDispatcher(), new sfFormatter());
