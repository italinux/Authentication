...
$numPerPage = 25;
$pager = new sfPropelPager('Author', $numPerPage);
...
$t->is(get_class($results), 'Propel_Collection');
...
$results = $pager->getResults(Propel::HYDRATE_ARRAY);
...
$pager->setQuery(Propel_Query::create()->from('Author a')->where('a.id < 9999999'));
$pager->setPage(1);
$pager->init();
...
$pager = new sfPropelPager('Author', 10);
$pager->init();
