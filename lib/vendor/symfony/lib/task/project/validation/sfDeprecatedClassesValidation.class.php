 ...
 * @version    SVN: $Id: sfDeprecatedClassesValidation.class.php 25411 2010-12-15 15:31:29Z fabien $
 */
class sfDeprecatedClassesValidation extends sfValidation
{
  ...
  {
    $classes = array(
      'sfPropelLogger', 'sfNoRouting', 'sfPathInfoRouting', 'sfRichTextEditor',
      'sfRichTextEditorFCK', 'sfRichTextEditorTinyMCE', 'sfCrudGenerator', 'sfAdminGenerator',
      'sfPropelCrudGenerator', 'sfPropelAdminGenerator', 'sfPropelUniqueValidator', 'sfPropelUniqueValidator',
      'sfLoader', 'sfConsoleRequest', 'sfConsoleResponse', 'sfConsoleController',
      'sfPropelDataRetriever', 'sfPropelDataRetriever',
      'sfWidgetFormI18nSelectLanguage', 'sfWidgetFormI18nSelectCurrency', 'sfWidgetFormI18nSelectCountry',
      'sfWidgetFormChoiceMany', 'sfWidgetFormPropelChoiceMany', 'sfWidgetFormPropelChoiceMany',
      'sfValidatorChoiceMany', 'sfValidatorPropelChoiceMany', 'sfValidatorPropelPropelMany',
