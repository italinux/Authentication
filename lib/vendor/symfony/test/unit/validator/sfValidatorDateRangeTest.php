...
$values = $v->clean(array('from' => '2008-01-01', 'to' => '2010-01-01'));
$t->is($values, array('from' => '2008-01-01', 'to' => '2010-01-01'), '->clean() returns the from and to values');
...
$values = $v->clean(array('custom_from' => '2008-01-01', 'custom_to' => '2010-01-01'));
$t->is($values, array('custom_from' => '2008-01-01', 'custom_to' => '2010-01-01'), '->clean() returns the from and to values for custom field names');
